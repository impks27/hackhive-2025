...
2. If the email contains text that belongs to multiple categories, create a JSON array where each object represents a distinct category and its associated fields.
...
4. Extract below fields for each category if found in inputs else mark as NA:
    ...
    * account_number
    * currency
5. Provide a brief explanation for each classification.
6. Provide the output in the following JSON format:
[
    {
        "classification": {
